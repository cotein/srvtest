...
Vue.component('Customer_edit', require('./components/app/customers/CustomerEdit.vue').default);
...
Vue.component('customer-new', require('./components/app/customers/new/CustomerBase').default);
