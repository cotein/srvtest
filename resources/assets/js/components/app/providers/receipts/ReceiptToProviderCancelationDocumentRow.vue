        ...
        <div class="col-md-12" style="margin-top:15px; margin-bottom:15px ; padding-bottom:15px; border-bottom:black solid 1px">
            ...
            <div class="text-center col-md-1"  > 
                <button 
                    ...
                    :disabled="!CanRemoveCancelationDocumentReceipToProvider"
                >
    ...
    export default {
        ...
        methods : {
            ...
            selectedPaymentType(el)
            {
                ...
                this.$store.commit('SET_RECEIPT_TO_PROVIDER_PAYMENT_TYPE', data);
            },
            ...
            selectedBank(el)
            {
                ...
                this.$store.commit('SET_RECEIPT_TO_PROVIDER_BANK', data);
            },

            remove_cancelation()
            {
                this.$store.commit('SET_RECEIPT_TO_PROVIDER_REMOVE_CANCELATION_DOCUMENT', this.number);
            },
            ...
            cancelationDocumentDate(value){
                ...
                this.$store.commit('SET_RECEIPT_TO_PROVIDER_CANCELATION_DOCUMENTS_DATE', data);
            },
            ...
            setCancelationNumber($e)
            {
                ...
                this.$store.commit('SET_RECEIPT_TO_PROVIDER_CANCELATION_DOCUMENTS_NUMBER', data);
            },
            ...
            setCancelationOwner($e)
            {
                ...
                this.$store.commit('SET_RECEIPT_TO_PROVIDER_CANCELATION_DOCUMENTS_OWNER', data);
            },
            ...
            setImport($e)
            {
                ...
                this.$store.commit('SET_RECEIPT_TO_PROVIDER_CANCELATION_DOCUMENTS_IMPORT', data);
            },
        ...
        computed : {
            ...mapGetters(
                [
                    'CanRemoveCancelationDocumentReceipToProvider',
